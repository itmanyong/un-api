...
/**
 * 生成单个 API 函数（内存模式）
 * @param apiDefine API 定义对象
 * @param requestor API 请求器函数
 * @returns API 函数
 */
 ...
 * @returns API 函数
 */
export const createProxyApi = <T extends ApiRequesterOptions>(apiDefine: T, requestor: ApiRequesterType): RecordType => {
