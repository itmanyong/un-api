...
import { createProxyApi } from "@itmanyong/un-api/browser";
 ...
 */
export const apiFinancePostCategoryProjectByAllocationCategoryId = createProxyApi(apis.finance.postCategoryProjectByAllocationCategoryId,axiosBaseClient);
/**
 * | 所属模块 | 接口名 | URL地址 | 请求类型 | 接口描述 |
 * | --- | --- | --- | --- | --- |
