...
export namespace AppModels {
  ...
  export type AppGetByIdHeader = Record<string, any>;
  export type AppGetByIdCookie = Record<string, any>;
  ...
  export type AppGetByIdGeneric = {
    ...
    data: AppGetByIdBody;
    header: AppGetByIdHeader;
    cookie: AppGetByIdCookie;
  ...
  export type AppPutByIdHeader = Record<string, any>;
  export type AppPutByIdCookie = Record<string, any>;
  ...
  export type AppPutByIdGeneric = {
    ...
    data: AppPutByIdBody;
    header: AppPutByIdHeader;
    cookie: AppPutByIdCookie;
  ...
  export type AppDeleteByIdHeader = Record<string, any>;
  export type AppDeleteByIdCookie = Record<string, any>;
  ...
  export type AppDeleteByIdGeneric = {
    ...
    header: AppDeleteByIdHeader;
    cookie: AppDeleteByIdCookie;
  ...
  export type AppPostHeader = Record<string, any>;
  export type AppPostCookie = Record<string, any>;
  ...
  export type AppPostGeneric = {
    ...
    data: AppPostBody;
    header: AppPostHeader;
    cookie: AppPostCookie;
  ...
  export type AppPostByIdStatusHeader = Record<string, any>;
  export type AppPostByIdStatusCookie = Record<string, any>;
  ...
  export type AppPostByIdStatusGeneric = {
    ...
    header: AppPostByIdStatusHeader;
    cookie: AppPostByIdStatusCookie;
  ...
  export type AppPostByIdRegenerateSecretHeader = Record<string, any>;
  export type AppPostByIdRegenerateSecretCookie = Record<string, any>;
  ...
  export type AppPostByIdRegenerateSecretGeneric = {
    ...
    header: AppPostByIdRegenerateSecretHeader;
    cookie: AppPostByIdRegenerateSecretCookie;
  ...
  export type AppGetPageHeader = Record<string, any>;
  export type AppGetPageCookie = Record<string, any>;
  ...
  export type AppGetPageGeneric = {
    ...
    data: AppGetPageBody;
    header: AppGetPageHeader;
    cookie: AppGetPageCookie;
