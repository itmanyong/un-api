...
export namespace FileModels {
  ...
  export type FilePostUploadHeader = Record<string, any>;
  ...
  export type FilePostUploadBatchHeader = Record<string, any>;
  export type FilePostUploadBatchCookie = Record<string, any>;
  ...
  export type FilePostUploadBatchGeneric = {
    ...
    header: FilePostUploadBatchHeader;
    cookie: FilePostUploadBatchCookie;
