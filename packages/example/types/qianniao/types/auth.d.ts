...
export namespace AuthModels {
  ...
  export type AuthPostValidateHeader = Record<string, any>;
  export type AuthPostValidateCookie = Record<string, any>;
  ...
  export type AuthPostValidateGeneric = {
    ...
    header: AuthPostValidateHeader;
    cookie: AuthPostValidateCookie;
  ...
  export type AuthPostRefreshHeader = Record<string, any>;
  export type AuthPostRefreshCookie = Record<string, any>;
  ...
  export type AuthPostRefreshGeneric = {
    ...
    header: AuthPostRefreshHeader;
    cookie: AuthPostRefreshCookie;
  ...
  export type AuthPostLogoutHeader = Record<string, any>;
  export type AuthPostLogoutCookie = Record<string, any>;
  ...
  export type AuthPostLogoutGeneric = {
    ...
    header: AuthPostLogoutHeader;
    cookie: AuthPostLogoutCookie;
  ...
  export type AuthPostLoginHeader = Record<string, any>;
  export type AuthPostLoginCookie = Record<string, any>;
  ...
  export type AuthPostLoginGeneric = {
    ...
    header: AuthPostLoginHeader;
    cookie: AuthPostLoginCookie;
  ...
  export type AuthGetInfoHeader = Record<string, any>;
  export type AuthGetInfoCookie = Record<string, any>;
  ...
  export type AuthGetInfoGeneric = {
    ...
    header: AuthGetInfoHeader;
    cookie: AuthGetInfoCookie;
