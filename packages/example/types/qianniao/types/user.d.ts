...
export namespace UserModels {
  ...
  export type UserGetAllEnumsHeader = Record<string, any>;
  export type UserGetAllEnumsCookie = Record<string, any>;
  ...
  export type UserGetAllEnumsGeneric = {
    ...
    header: UserGetAllEnumsHeader;
    cookie: UserGetAllEnumsCookie;
