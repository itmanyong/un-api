...
export namespace InstitutionModels {
  ...
  export type InstitutionPutItemHeader = Record<string, any>;
  export type InstitutionPutItemCookie = Record<string, any>;
  ...
  export type InstitutionPutItemGeneric = {
    ...
    header: InstitutionPutItemHeader;
    cookie: InstitutionPutItemCookie;
  ...
  export type InstitutionPostItemHeader = Record<string, any>;
  export type InstitutionPostItemCookie = Record<string, any>;
  ...
  export type InstitutionPostItemGeneric = {
    ...
    header: InstitutionPostItemHeader;
    cookie: InstitutionPostItemCookie;
  ...
  export type InstitutionPostEnterAuditHeader = Record<string, any>;
  export type InstitutionPostEnterAuditCookie = Record<string, any>;
  ...
  export type InstitutionPostEnterAuditGeneric = {
    ...
    header: InstitutionPostEnterAuditHeader;
    cookie: InstitutionPostEnterAuditCookie;
   ...
   * @description
   */
  export type InstitutionGetPageQuery = XinliModels.InstitutionPageQuery;
  export type InstitutionGetPageParams = Record<string, any>;
  export type InstitutionGetPageBody = any;
  export type InstitutionGetPageHeader = Record<string, any>;
  export type InstitutionGetPageCookie = Record<string, any>;
  ...
  export type InstitutionGetPageGeneric = {
    ...
    header: InstitutionGetPageHeader;
    cookie: InstitutionGetPageCookie;
  ...
  export type InstitutionGetGetPasswordByIdHeader = Record<string, any>;
  export type InstitutionGetGetPasswordByIdCookie = Record<string, any>;
  ...
  export type InstitutionGetGetPasswordByIdGeneric = {
    ...
    header: InstitutionGetGetPasswordByIdHeader;
    cookie: InstitutionGetGetPasswordByIdCookie;
  ...
  export type InstitutionDeleteListHeader = Record<string, any>;
  export type InstitutionDeleteListCookie = Record<string, any>;
  ...
  export type InstitutionDeleteListGeneric = {
    ...
    header: InstitutionDeleteListHeader;
    cookie: InstitutionDeleteListCookie;
  ...
  export type InstitutionDeleteItemByIdHeader = Record<string, any>;
  export type InstitutionDeleteItemByIdCookie = Record<string, any>;
  ...
  export type InstitutionDeleteItemByIdGeneric = {
    ...
    header: InstitutionDeleteItemByIdHeader;
    cookie: InstitutionDeleteItemByIdCookie;
