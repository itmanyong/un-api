...
export namespace ImModels {
  ...
  export type ImPostLoginHeader = Record<string, any>;
  export type ImPostLoginCookie = Record<string, any>;
  ...
  export type ImPostLoginGeneric = {
    ...
    header: ImPostLoginHeader;
    cookie: ImPostLoginCookie;
  ...
  export type ImGetLinkHeader = Record<string, any>;
  export type ImGetLinkCookie = Record<string, any>;
  ...
  export type ImGetLinkGeneric = {
    ...
    data: ImGetLinkBody;
    header: ImGetLinkHeader;
    cookie: ImGetLinkCookie;
  ...
  export type ImGetInfoHeader = Record<string, any>;
  export type ImGetInfoCookie = Record<string, any>;
  ...
  export type ImGetInfoGeneric = {
    ...
    data: ImGetInfoBody;
    header: ImGetInfoHeader;
    cookie: ImGetInfoCookie;
