...
export namespace UserInfoModels {
  ...
  export type UserInfoPutItemHeader = Record<string, any>;
  export type UserInfoPutItemCookie = Record<string, any>;
  ...
  export type UserInfoPutItemGeneric = {
    ...
    header: UserInfoPutItemHeader;
    cookie: UserInfoPutItemCookie;
  ...
  export type UserInfoPostItemHeader = Record<string, any>;
  export type UserInfoPostItemCookie = Record<string, any>;
  ...
  export type UserInfoPostItemGeneric = {
    ...
    header: UserInfoPostItemHeader;
    cookie: UserInfoPostItemCookie;
  ...
  export type UserInfoDeleteItemHeader = Record<string, any>;
  export type UserInfoDeleteItemCookie = Record<string, any>;
  ...
  export type UserInfoDeleteItemGeneric = {
    ...
    header: UserInfoDeleteItemHeader;
    cookie: UserInfoDeleteItemCookie;
  ...
  export type UserInfoPostGetUserNameByIdHeader = Record<string, any>;
  export type UserInfoPostGetUserNameByIdCookie = Record<string, any>;
  ...
  export type UserInfoPostGetUserNameByIdGeneric = {
    ...
    header: UserInfoPostGetUserNameByIdHeader;
    cookie: UserInfoPostGetUserNameByIdCookie;
   ...
   * @description 用户分页查询
   */
  export type UserInfoGetPageQuery = XinliModels.UserInfoPageQuery;
  export type UserInfoGetPageParams = Record<string, any>;
  export type UserInfoGetPageBody = any;
  export type UserInfoGetPageHeader = Record<string, any>;
  export type UserInfoGetPageCookie = Record<string, any>;
  ...
  export type UserInfoGetPageGeneric = {
    ...
    header: UserInfoGetPageHeader;
    cookie: UserInfoGetPageCookie;
  ...
  export type UserInfoGetItemByIdHeader = Record<string, any>;
  export type UserInfoGetItemByIdCookie = Record<string, any>;
  ...
  export type UserInfoGetItemByIdGeneric = {
    ...
    header: UserInfoGetItemByIdHeader;
    cookie: UserInfoGetItemByIdCookie;
  ...
  export type UserInfoDeleteItemByIdHeader = Record<string, any>;
  export type UserInfoDeleteItemByIdCookie = Record<string, any>;
  ...
  export type UserInfoDeleteItemByIdGeneric = {
    ...
    header: UserInfoDeleteItemByIdHeader;
    cookie: UserInfoDeleteItemByIdCookie;
  ...
  export type UserInfoGetGetUserInfoHeader = Record<string, any>;
  export type UserInfoGetGetUserInfoCookie = Record<string, any>;
  ...
  export type UserInfoGetGetUserInfoGeneric = {
    ...
    header: UserInfoGetGetUserInfoHeader;
    cookie: UserInfoGetGetUserInfoCookie;
  ...
  export type UserInfoGetGetAvaByIdByIdHeader = Record<string, any>;
  export type UserInfoGetGetAvaByIdByIdCookie = Record<string, any>;
  ...
  export type UserInfoGetGetAvaByIdByIdGeneric = {
    ...
    header: UserInfoGetGetAvaByIdByIdHeader;
    cookie: UserInfoGetGetAvaByIdByIdCookie;
