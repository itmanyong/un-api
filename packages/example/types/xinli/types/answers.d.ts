...
export namespace AnswersModels {
  ...
  export type AnswersPutListHeader = Record<string, any>;
  export type AnswersPutListCookie = Record<string, any>;
  ...
  export type AnswersPutListGeneric = {
    ...
    header: AnswersPutListHeader;
    cookie: AnswersPutListCookie;
  ...
  export type AnswersPostListHeader = Record<string, any>;
  export type AnswersPostListCookie = Record<string, any>;
  ...
  export type AnswersPostListGeneric = {
    ...
    header: AnswersPostListHeader;
    cookie: AnswersPostListCookie;
  ...
  export type AnswersDeleteListHeader = Record<string, any>;
  export type AnswersDeleteListCookie = Record<string, any>;
  ...
  export type AnswersDeleteListGeneric = {
    ...
    header: AnswersDeleteListHeader;
    cookie: AnswersDeleteListCookie;
  ...
  export type AnswersPutItemHeader = Record<string, any>;
  export type AnswersPutItemCookie = Record<string, any>;
  ...
  export type AnswersPutItemGeneric = {
    ...
    header: AnswersPutItemHeader;
    cookie: AnswersPutItemCookie;
  ...
  export type AnswersPostItemHeader = Record<string, any>;
  export type AnswersPostItemCookie = Record<string, any>;
  ...
  export type AnswersPostItemGeneric = {
    ...
    header: AnswersPostItemHeader;
    cookie: AnswersPostItemCookie;
  ...
  export type AnswersPostListQueryHeader = Record<string, any>;
  export type AnswersPostListQueryCookie = Record<string, any>;
  ...
  export type AnswersPostListQueryGeneric = {
    ...
    header: AnswersPostListQueryHeader;
    cookie: AnswersPostListQueryCookie;
   ...
   * @description
   */
  export type AnswersGetPageQuery = XinliModels.AnswersPageQuery;
  export type AnswersGetPageParams = Record<string, any>;
  export type AnswersGetPageBody = any;
  export type AnswersGetPageHeader = Record<string, any>;
  export type AnswersGetPageCookie = Record<string, any>;
  ...
  export type AnswersGetPageGeneric = {
    ...
    header: AnswersGetPageHeader;
    cookie: AnswersGetPageCookie;
  ...
  export type AnswersGetItemByIdHeader = Record<string, any>;
  export type AnswersGetItemByIdCookie = Record<string, any>;
  ...
  export type AnswersGetItemByIdGeneric = {
    ...
    header: AnswersGetItemByIdHeader;
    cookie: AnswersGetItemByIdCookie;
  ...
  export type AnswersDeleteItemByIdHeader = Record<string, any>;
  export type AnswersDeleteItemByIdCookie = Record<string, any>;
  ...
  export type AnswersDeleteItemByIdGeneric = {
    ...
    header: AnswersDeleteItemByIdHeader;
    cookie: AnswersDeleteItemByIdCookie;
