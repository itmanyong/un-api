...
export namespace QuestionsModels {
  ...
  export type QuestionsPutUpdateStatusByIdHeader = Record<string, any>;
  export type QuestionsPutUpdateStatusByIdCookie = Record<string, any>;
  ...
  export type QuestionsPutUpdateStatusByIdGeneric = {
    ...
    header: QuestionsPutUpdateStatusByIdHeader;
    cookie: QuestionsPutUpdateStatusByIdCookie;
  ...
  export type QuestionsPutListHeader = Record<string, any>;
  export type QuestionsPutListCookie = Record<string, any>;
  ...
  export type QuestionsPutListGeneric = {
    ...
    header: QuestionsPutListHeader;
    cookie: QuestionsPutListCookie;
  ...
  export type QuestionsPostListHeader = Record<string, any>;
  export type QuestionsPostListCookie = Record<string, any>;
  ...
  export type QuestionsPostListGeneric = {
    ...
    header: QuestionsPostListHeader;
    cookie: QuestionsPostListCookie;
  ...
  export type QuestionsDeleteListHeader = Record<string, any>;
  export type QuestionsDeleteListCookie = Record<string, any>;
  ...
  export type QuestionsDeleteListGeneric = {
    ...
    header: QuestionsDeleteListHeader;
    cookie: QuestionsDeleteListCookie;
  ...
  export type QuestionsPutItemHeader = Record<string, any>;
  export type QuestionsPutItemCookie = Record<string, any>;
  ...
  export type QuestionsPutItemGeneric = {
    ...
    header: QuestionsPutItemHeader;
    cookie: QuestionsPutItemCookie;
  ...
  export type QuestionsPostItemHeader = Record<string, any>;
  export type QuestionsPostItemCookie = Record<string, any>;
  ...
  export type QuestionsPostItemGeneric = {
    ...
    header: QuestionsPostItemHeader;
    cookie: QuestionsPostItemCookie;
  ...
  export type QuestionsPostListQueryHeader = Record<string, any>;
  export type QuestionsPostListQueryCookie = Record<string, any>;
  ...
  export type QuestionsPostListQueryGeneric = {
    ...
    header: QuestionsPostListQueryHeader;
    cookie: QuestionsPostListQueryCookie;
   ...
   * @description
   */
  export type QuestionsGetPageQuery = XinliModels.QuestionsPageQuery;
  export type QuestionsGetPageParams = Record<string, any>;
  export type QuestionsGetPageBody = any;
  export type QuestionsGetPageHeader = Record<string, any>;
  export type QuestionsGetPageCookie = Record<string, any>;
  ...
  export type QuestionsGetPageGeneric = {
    ...
    header: QuestionsGetPageHeader;
    cookie: QuestionsGetPageCookie;
  ...
  export type QuestionsGetItemByIdHeader = Record<string, any>;
  export type QuestionsGetItemByIdCookie = Record<string, any>;
  ...
  export type QuestionsGetItemByIdGeneric = {
    ...
    header: QuestionsGetItemByIdHeader;
    cookie: QuestionsGetItemByIdCookie;
  ...
  export type QuestionsDeleteItemByIdHeader = Record<string, any>;
  export type QuestionsDeleteItemByIdCookie = Record<string, any>;
  ...
  export type QuestionsDeleteItemByIdGeneric = {
    ...
    header: QuestionsDeleteItemByIdHeader;
    cookie: QuestionsDeleteItemByIdCookie;
