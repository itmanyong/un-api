...
export namespace AnnouncementModels {
  ...
  export type AnnouncementPutUpdateStatusByIdHeader = Record<string, any>;
  export type AnnouncementPutUpdateStatusByIdCookie = Record<string, any>;
  ...
  export type AnnouncementPutUpdateStatusByIdGeneric = {
    ...
    header: AnnouncementPutUpdateStatusByIdHeader;
    cookie: AnnouncementPutUpdateStatusByIdCookie;
  ...
  export type AnnouncementPutListHeader = Record<string, any>;
  export type AnnouncementPutListCookie = Record<string, any>;
  ...
  export type AnnouncementPutListGeneric = {
    ...
    header: AnnouncementPutListHeader;
    cookie: AnnouncementPutListCookie;
  ...
  export type AnnouncementPostListHeader = Record<string, any>;
  export type AnnouncementPostListCookie = Record<string, any>;
  ...
  export type AnnouncementPostListGeneric = {
    ...
    header: AnnouncementPostListHeader;
    cookie: AnnouncementPostListCookie;
  ...
  export type AnnouncementDeleteListHeader = Record<string, any>;
  export type AnnouncementDeleteListCookie = Record<string, any>;
  ...
  export type AnnouncementDeleteListGeneric = {
    ...
    header: AnnouncementDeleteListHeader;
    cookie: AnnouncementDeleteListCookie;
  ...
  export type AnnouncementPutItemHeader = Record<string, any>;
  export type AnnouncementPutItemCookie = Record<string, any>;
  ...
  export type AnnouncementPutItemGeneric = {
    ...
    header: AnnouncementPutItemHeader;
    cookie: AnnouncementPutItemCookie;
  ...
  export type AnnouncementPostItemHeader = Record<string, any>;
  export type AnnouncementPostItemCookie = Record<string, any>;
  ...
  export type AnnouncementPostItemGeneric = {
    ...
    header: AnnouncementPostItemHeader;
    cookie: AnnouncementPostItemCookie;
  ...
  export type AnnouncementPostListQueryHeader = Record<string, any>;
  export type AnnouncementPostListQueryCookie = Record<string, any>;
  ...
  export type AnnouncementPostListQueryGeneric = {
    ...
    header: AnnouncementPostListQueryHeader;
    cookie: AnnouncementPostListQueryCookie;
   ...
   * @description
   */
  export type AnnouncementGetPageQuery = XinliModels.AnnouncementPageQuery;
  export type AnnouncementGetPageParams = Record<string, any>;
  export type AnnouncementGetPageBody = any;
  export type AnnouncementGetPageHeader = Record<string, any>;
  export type AnnouncementGetPageCookie = Record<string, any>;
  ...
  export type AnnouncementGetPageGeneric = {
    ...
    header: AnnouncementGetPageHeader;
    cookie: AnnouncementGetPageCookie;
  ...
  export type AnnouncementGetItemByIdHeader = Record<string, any>;
  export type AnnouncementGetItemByIdCookie = Record<string, any>;
  ...
  export type AnnouncementGetItemByIdGeneric = {
    ...
    header: AnnouncementGetItemByIdHeader;
    cookie: AnnouncementGetItemByIdCookie;
  ...
  export type AnnouncementDeleteItemByIdHeader = Record<string, any>;
  export type AnnouncementDeleteItemByIdCookie = Record<string, any>;
  ...
  export type AnnouncementDeleteItemByIdGeneric = {
    ...
    header: AnnouncementDeleteItemByIdHeader;
    cookie: AnnouncementDeleteItemByIdCookie;
