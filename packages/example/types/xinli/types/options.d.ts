...
export namespace OptionsModels {
  ...
  export type OptionsPutListHeader = Record<string, any>;
  export type OptionsPutListCookie = Record<string, any>;
  ...
  export type OptionsPutListGeneric = {
    ...
    header: OptionsPutListHeader;
    cookie: OptionsPutListCookie;
  ...
  export type OptionsPostListHeader = Record<string, any>;
  export type OptionsPostListCookie = Record<string, any>;
  ...
  export type OptionsPostListGeneric = {
    ...
    header: OptionsPostListHeader;
    cookie: OptionsPostListCookie;
  ...
  export type OptionsDeleteListHeader = Record<string, any>;
  export type OptionsDeleteListCookie = Record<string, any>;
  ...
  export type OptionsDeleteListGeneric = {
    ...
    header: OptionsDeleteListHeader;
    cookie: OptionsDeleteListCookie;
  ...
  export type OptionsPutItemHeader = Record<string, any>;
  export type OptionsPutItemCookie = Record<string, any>;
  ...
  export type OptionsPutItemGeneric = {
    ...
    header: OptionsPutItemHeader;
    cookie: OptionsPutItemCookie;
  ...
  export type OptionsPostItemHeader = Record<string, any>;
  export type OptionsPostItemCookie = Record<string, any>;
  ...
  export type OptionsPostItemGeneric = {
    ...
    header: OptionsPostItemHeader;
    cookie: OptionsPostItemCookie;
  ...
  export type OptionsPostListQueryHeader = Record<string, any>;
  export type OptionsPostListQueryCookie = Record<string, any>;
  ...
  export type OptionsPostListQueryGeneric = {
    ...
    header: OptionsPostListQueryHeader;
    cookie: OptionsPostListQueryCookie;
   ...
   * @description
   */
  export type OptionsGetPageQuery = XinliModels.OptionsPageQuery;
  export type OptionsGetPageParams = Record<string, any>;
  export type OptionsGetPageBody = any;
  export type OptionsGetPageHeader = Record<string, any>;
  export type OptionsGetPageCookie = Record<string, any>;
  ...
  export type OptionsGetPageGeneric = {
    ...
    header: OptionsGetPageHeader;
    cookie: OptionsGetPageCookie;
  ...
  export type OptionsGetItemByIdHeader = Record<string, any>;
  export type OptionsGetItemByIdCookie = Record<string, any>;
  ...
  export type OptionsGetItemByIdGeneric = {
    ...
    header: OptionsGetItemByIdHeader;
    cookie: OptionsGetItemByIdCookie;
  ...
  export type OptionsDeleteItemByIdHeader = Record<string, any>;
  export type OptionsDeleteItemByIdCookie = Record<string, any>;
  ...
  export type OptionsDeleteItemByIdGeneric = {
    ...
    header: OptionsDeleteItemByIdHeader;
    cookie: OptionsDeleteItemByIdCookie;
