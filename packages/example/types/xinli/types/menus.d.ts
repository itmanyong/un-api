...
export namespace MenusModels {
  ...
  export type MenusPutItemHeader = Record<string, any>;
  export type MenusPutItemCookie = Record<string, any>;
  ...
  export type MenusPutItemGeneric = {
    ...
    header: MenusPutItemHeader;
    cookie: MenusPutItemCookie;
  ...
  export type MenusPostItemHeader = Record<string, any>;
  export type MenusPostItemCookie = Record<string, any>;
  ...
  export type MenusPostItemGeneric = {
    ...
    header: MenusPostItemHeader;
    cookie: MenusPostItemCookie;
  ...
  export type MenusPostListQueryHeader = Record<string, any>;
  export type MenusPostListQueryCookie = Record<string, any>;
  ...
  export type MenusPostListQueryGeneric = {
    ...
    header: MenusPostListQueryHeader;
    cookie: MenusPostListQueryCookie;
   ...
   * @description 菜单分页查询
   */
  export type MenusGetPageQuery = XinliModels.MenusPageQuery;
  export type MenusGetPageParams = Record<string, any>;
  export type MenusGetPageBody = any;
  export type MenusGetPageHeader = Record<string, any>;
  export type MenusGetPageCookie = Record<string, any>;
  ...
  export type MenusGetPageGeneric = {
    ...
    header: MenusGetPageHeader;
    cookie: MenusGetPageCookie;
  ...
  export type MenusGetGetByRoleIdHeader = Record<string, any>;
  export type MenusGetGetByRoleIdCookie = Record<string, any>;
  ...
  export type MenusGetGetByRoleIdGeneric = {
    ...
    header: MenusGetGetByRoleIdHeader;
    cookie: MenusGetGetByRoleIdCookie;
  ...
  export type MenusGetGetByAccountIdHeader = Record<string, any>;
  export type MenusGetGetByAccountIdCookie = Record<string, any>;
  ...
  export type MenusGetGetByAccountIdGeneric = {
    ...
    header: MenusGetGetByAccountIdHeader;
    cookie: MenusGetGetByAccountIdCookie;
  ...
  export type MenusDeleteListHeader = Record<string, any>;
  export type MenusDeleteListCookie = Record<string, any>;
  ...
  export type MenusDeleteListGeneric = {
    ...
    header: MenusDeleteListHeader;
    cookie: MenusDeleteListCookie;
  ...
  export type MenusDeleteItemByIdHeader = Record<string, any>;
  export type MenusDeleteItemByIdCookie = Record<string, any>;
  ...
  export type MenusDeleteItemByIdGeneric = {
    ...
    header: MenusDeleteItemByIdHeader;
    cookie: MenusDeleteItemByIdCookie;
