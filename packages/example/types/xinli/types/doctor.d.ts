...
export namespace DoctorModels {
  ...
  export type DoctorPutItemHeader = Record<string, any>;
  export type DoctorPutItemCookie = Record<string, any>;
  ...
  export type DoctorPutItemGeneric = {
    ...
    header: DoctorPutItemHeader;
    cookie: DoctorPutItemCookie;
  ...
  export type DoctorPostItemHeader = Record<string, any>;
  export type DoctorPostItemCookie = Record<string, any>;
  ...
  export type DoctorPostItemGeneric = {
    ...
    header: DoctorPostItemHeader;
    cookie: DoctorPostItemCookie;
  ...
  export type DoctorPostPutStatusByIdByStatusHeader = Record<string, any>;
  export type DoctorPostPutStatusByIdByStatusCookie = Record<string, any>;
  ...
  export type DoctorPostPutStatusByIdByStatusGeneric = {
    ...
    header: DoctorPostPutStatusByIdByStatusHeader;
    cookie: DoctorPostPutStatusByIdByStatusCookie;
  ...
  export type DoctorPostEnterAuditHeader = Record<string, any>;
  export type DoctorPostEnterAuditCookie = Record<string, any>;
  ...
  export type DoctorPostEnterAuditGeneric = {
    ...
    header: DoctorPostEnterAuditHeader;
    cookie: DoctorPostEnterAuditCookie;
   ...
   * @description
   */
  export type DoctorGetPageQuery = XinliModels.DoctorPageQuery;
  export type DoctorGetPageParams = Record<string, any>;
  export type DoctorGetPageBody = any;
  export type DoctorGetPageHeader = Record<string, any>;
  export type DoctorGetPageCookie = Record<string, any>;
  ...
  export type DoctorGetPageGeneric = {
    ...
    header: DoctorGetPageHeader;
    cookie: DoctorGetPageCookie;
  ...
  export type DoctorDeleteListHeader = Record<string, any>;
  export type DoctorDeleteListCookie = Record<string, any>;
  ...
  export type DoctorDeleteListGeneric = {
    ...
    header: DoctorDeleteListHeader;
    cookie: DoctorDeleteListCookie;
  ...
  export type DoctorDeleteItemByIdHeader = Record<string, any>;
  export type DoctorDeleteItemByIdCookie = Record<string, any>;
  ...
  export type DoctorDeleteItemByIdGeneric = {
    ...
    header: DoctorDeleteItemByIdHeader;
    cookie: DoctorDeleteItemByIdCookie;
