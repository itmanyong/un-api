...
export namespace DictDataModels {
  ...
  export type DictDataPutByIdHeader = Record<string, any>;
  export type DictDataPutByIdCookie = Record<string, any>;
  ...
  export type DictDataPutByIdGeneric = {
    ...
    header: DictDataPutByIdHeader;
    cookie: DictDataPutByIdCookie;
  ...
  export type DictDataDeleteByIdHeader = Record<string, any>;
  export type DictDataDeleteByIdCookie = Record<string, any>;
  ...
  export type DictDataDeleteByIdGeneric = {
    ...
    header: DictDataDeleteByIdHeader;
    cookie: DictDataDeleteByIdCookie;
  ...
  export type DictDataPutStatusByIdHeader = Record<string, any>;
  export type DictDataPutStatusByIdCookie = Record<string, any>;
  ...
  export type DictDataPutStatusByIdGeneric = {
    ...
    header: DictDataPutStatusByIdHeader;
    cookie: DictDataPutStatusByIdCookie;
  ...
  export type DictDataPostHeader = Record<string, any>;
  export type DictDataPostCookie = Record<string, any>;
  ...
  export type DictDataPostGeneric = {
    ...
    header: DictDataPostHeader;
    cookie: DictDataPostCookie;
  ...
  export type DictDataGetPageHeader = Record<string, any>;
  export type DictDataGetPageCookie = Record<string, any>;
  ...
  export type DictDataGetPageGeneric = {
    ...
    header: DictDataGetPageHeader;
    cookie: DictDataGetPageCookie;
  ...
  export type DictDataDeleteListHeader = Record<string, any>;
  export type DictDataDeleteListCookie = Record<string, any>;
  ...
  export type DictDataDeleteListGeneric = {
    ...
    header: DictDataDeleteListHeader;
    cookie: DictDataDeleteListCookie;
