...
export namespace FinanceCategoryModels {
  ...
  export type FinanceCategoryPutByIdHeader = Record<string, any>;
  export type FinanceCategoryPutByIdCookie = Record<string, any>;
  ...
  export type FinanceCategoryPutByIdGeneric = {
    ...
    header: FinanceCategoryPutByIdHeader;
    cookie: FinanceCategoryPutByIdCookie;
  ...
  export type FinanceCategoryPutStatusHeader = Record<string, any>;
  export type FinanceCategoryPutStatusCookie = Record<string, any>;
  ...
  export type FinanceCategoryPutStatusGeneric = {
    ...
    header: FinanceCategoryPutStatusHeader;
    cookie: FinanceCategoryPutStatusCookie;
  ...
  export type FinanceCategoryPostHeader = Record<string, any>;
  export type FinanceCategoryPostCookie = Record<string, any>;
  ...
  export type FinanceCategoryPostGeneric = {
    ...
    header: FinanceCategoryPostHeader;
    cookie: FinanceCategoryPostCookie;
  ...
  export type FinanceCategoryPostListHeader = Record<string, any>;
  export type FinanceCategoryPostListCookie = Record<string, any>;
  ...
  export type FinanceCategoryPostListGeneric = {
    ...
    header: FinanceCategoryPostListHeader;
    cookie: FinanceCategoryPostListCookie;
  ...
  export type FinanceCategoryGetPageHeader = Record<string, any>;
  export type FinanceCategoryGetPageCookie = Record<string, any>;
  ...
  export type FinanceCategoryGetPageGeneric = {
    ...
    header: FinanceCategoryGetPageHeader;
    cookie: FinanceCategoryGetPageCookie;
