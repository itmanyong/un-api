...
export namespace UserModels {
  ...
  export type UserPutByIdHeader = Record<string, any>;
  export type UserPutByIdCookie = Record<string, any>;
  ...
  export type UserPutByIdGeneric = {
    ...
    header: UserPutByIdHeader;
    cookie: UserPutByIdCookie;
  ...
  export type UserPostHeader = Record<string, any>;
  export type UserPostCookie = Record<string, any>;
  ...
  export type UserPostGeneric = {
    ...
    data: UserPostBody;
    header: UserPostHeader;
    cookie: UserPostCookie;
  ...
  export type UserPostListHeader = Record<string, any>;
  export type UserPostListCookie = Record<string, any>;
  ...
  export type UserPostListGeneric = {
    ...
    header: UserPostListHeader;
    cookie: UserPostListCookie;
  ...
  export type UserPostListByAccountHeader = Record<string, any>;
  export type UserPostListByAccountCookie = Record<string, any>;
  ...
  export type UserPostListByAccountGeneric = {
    ...
    header: UserPostListByAccountHeader;
    cookie: UserPostListByAccountCookie;
  ...
  export type UserGetPageHeader = Record<string, any>;
  export type UserGetPageCookie = Record<string, any>;
  ...
  export type UserGetPageGeneric = {
    ...
    header: UserGetPageHeader;
    cookie: UserGetPageCookie;
  ...
  export type UserGetGetIMLinkHeader = Record<string, any>;
  export type UserGetGetIMLinkCookie = Record<string, any>;
  ...
  export type UserGetGetIMLinkGeneric = {
    ...
    header: UserGetGetIMLinkHeader;
    cookie: UserGetGetIMLinkCookie;
  ...
  export type UserGetGetAccountInfoHeader = Record<string, any>;
  export type UserGetGetAccountInfoCookie = Record<string, any>;
  ...
  export type UserGetGetAccountInfoGeneric = {
    ...
    header: UserGetGetAccountInfoHeader;
    cookie: UserGetGetAccountInfoCookie;
