...
export namespace DepartmentModels {
  ...
  export type DepartmentPutByIdHeader = Record<string, any>;
  export type DepartmentPutByIdCookie = Record<string, any>;
  ...
  export type DepartmentPutByIdGeneric = {
    ...
    header: DepartmentPutByIdHeader;
    cookie: DepartmentPutByIdCookie;
  ...
  export type DepartmentDeleteByIdHeader = Record<string, any>;
  export type DepartmentDeleteByIdCookie = Record<string, any>;
  ...
  export type DepartmentDeleteByIdGeneric = {
    ...
    header: DepartmentDeleteByIdHeader;
    cookie: DepartmentDeleteByIdCookie;
  ...
  export type DepartmentPutStatusHeader = Record<string, any>;
  export type DepartmentPutStatusCookie = Record<string, any>;
  ...
  export type DepartmentPutStatusGeneric = {
    ...
    header: DepartmentPutStatusHeader;
    cookie: DepartmentPutStatusCookie;
  ...
  export type DepartmentPostHeader = Record<string, any>;
  export type DepartmentPostCookie = Record<string, any>;
  ...
  export type DepartmentPostGeneric = {
    ...
    header: DepartmentPostHeader;
    cookie: DepartmentPostCookie;
  ...
  export type DepartmentPostListHeader = Record<string, any>;
  export type DepartmentPostListCookie = Record<string, any>;
  ...
  export type DepartmentPostListGeneric = {
    ...
    header: DepartmentPostListHeader;
    cookie: DepartmentPostListCookie;
  ...
  export type DepartmentDeleteListHeader = Record<string, any>;
  export type DepartmentDeleteListCookie = Record<string, any>;
  ...
  export type DepartmentDeleteListGeneric = {
    ...
    header: DepartmentDeleteListHeader;
    cookie: DepartmentDeleteListCookie;
  ...
  export type DepartmentGetPageHeader = Record<string, any>;
  export type DepartmentGetPageCookie = Record<string, any>;
  ...
  export type DepartmentGetPageGeneric = {
    ...
    header: DepartmentGetPageHeader;
    cookie: DepartmentGetPageCookie;
