...
export namespace RoleModels {
  ...
  export type RoleGetByIdHeader = Record<string, any>;
  export type RoleGetByIdCookie = Record<string, any>;
  ...
  export type RoleGetByIdGeneric = {
    ...
    header: RoleGetByIdHeader;
    cookie: RoleGetByIdCookie;
  ...
  export type RolePutByIdHeader = Record<string, any>;
  export type RolePutByIdCookie = Record<string, any>;
  ...
  export type RolePutByIdGeneric = {
    ...
    header: RolePutByIdHeader;
    cookie: RolePutByIdCookie;
  ...
  export type RoleDeleteByIdHeader = Record<string, any>;
  export type RoleDeleteByIdCookie = Record<string, any>;
  ...
  export type RoleDeleteByIdGeneric = {
    ...
    header: RoleDeleteByIdHeader;
    cookie: RoleDeleteByIdCookie;
  ...
  export type RolePutListHeader = Record<string, any>;
  export type RolePutListCookie = Record<string, any>;
  ...
  export type RolePutListGeneric = {
    ...
    header: RolePutListHeader;
    cookie: RolePutListCookie;
  ...
  export type RolePostListHeader = Record<string, any>;
  export type RolePostListCookie = Record<string, any>;
  ...
  export type RolePostListGeneric = {
    ...
    header: RolePostListHeader;
    cookie: RolePostListCookie;
  ...
  export type RolePostHeader = Record<string, any>;
  export type RolePostCookie = Record<string, any>;
  ...
  export type RolePostGeneric = {
    ...
    data: RolePostBody;
    header: RolePostHeader;
    cookie: RolePostCookie;
