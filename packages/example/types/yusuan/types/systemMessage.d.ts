...
export namespace SystemMessageModels {
  ...
  export type SystemMessagePutReadByIdHeader = Record<string, any>;
  export type SystemMessagePutReadByIdCookie = Record<string, any>;
  ...
  export type SystemMessagePutReadByIdGeneric = {
    ...
    header: SystemMessagePutReadByIdHeader;
    cookie: SystemMessagePutReadByIdCookie;
  ...
  export type SystemMessageGetCurrentPageHeader = Record<string, any>;
  export type SystemMessageGetCurrentPageCookie = Record<string, any>;
  ...
  export type SystemMessageGetCurrentPageGeneric = {
    ...
    header: SystemMessageGetCurrentPageHeader;
    cookie: SystemMessageGetCurrentPageCookie;
