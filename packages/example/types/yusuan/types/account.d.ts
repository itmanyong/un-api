...
export namespace AccountModels {
  ...
  export type AccountPutUpdatePasswordCurrentHeader = Record<string, any>;
  export type AccountPutUpdatePasswordCurrentCookie = Record<string, any>;
  ...
  export type AccountPutUpdatePasswordCurrentGeneric = {
    ...
    header: AccountPutUpdatePasswordCurrentHeader;
    cookie: AccountPutUpdatePasswordCurrentCookie;
  ...
  export type AccountPutUpdatePasswordAdminHeader = Record<string, any>;
  export type AccountPutUpdatePasswordAdminCookie = Record<string, any>;
  ...
  export type AccountPutUpdatePasswordAdminGeneric = {
    ...
    header: AccountPutUpdatePasswordAdminHeader;
    cookie: AccountPutUpdatePasswordAdminCookie;
  ...
  export type AccountPutStatusHeader = Record<string, any>;
  export type AccountPutStatusCookie = Record<string, any>;
  ...
  export type AccountPutStatusGeneric = {
    ...
    header: AccountPutStatusHeader;
    cookie: AccountPutStatusCookie;
