...
export namespace ProjectCategoryModels {
  ...
  export type ProjectCategoryPutByIdHeader = Record<string, any>;
  export type ProjectCategoryPutByIdCookie = Record<string, any>;
  ...
  export type ProjectCategoryPutByIdGeneric = {
    ...
    header: ProjectCategoryPutByIdHeader;
    cookie: ProjectCategoryPutByIdCookie;
  ...
  export type ProjectCategoryPutStatusHeader = Record<string, any>;
  export type ProjectCategoryPutStatusCookie = Record<string, any>;
  ...
  export type ProjectCategoryPutStatusGeneric = {
    ...
    header: ProjectCategoryPutStatusHeader;
    cookie: ProjectCategoryPutStatusCookie;
  ...
  export type ProjectCategoryPostHeader = Record<string, any>;
  export type ProjectCategoryPostCookie = Record<string, any>;
  ...
  export type ProjectCategoryPostGeneric = {
    ...
    header: ProjectCategoryPostHeader;
    cookie: ProjectCategoryPostCookie;
  ...
  export type ProjectCategoryPostListHeader = Record<string, any>;
  export type ProjectCategoryPostListCookie = Record<string, any>;
  ...
  export type ProjectCategoryPostListGeneric = {
    ...
    header: ProjectCategoryPostListHeader;
    cookie: ProjectCategoryPostListCookie;
  ...
  export type ProjectCategoryGetPageHeader = Record<string, any>;
  export type ProjectCategoryGetPageCookie = Record<string, any>;
  ...
  export type ProjectCategoryGetPageGeneric = {
    ...
    header: ProjectCategoryGetPageHeader;
    cookie: ProjectCategoryGetPageCookie;
